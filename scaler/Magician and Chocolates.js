// question --> https://www.scaler.com/academy/mentee-dashboard/class/52308/assignment/problems/362/?navref=cl_pb_nv_tb
...
https: module.exports = {
  ...
  nchoc: function (A, B) {
    let maxChocoEaten = 0;
    let maxHeap = new MaxHeap(B);
    let mod = 1000000007;
    for (let i = 0; i < A; i++) {
      let currentMax = maxHeap.poll();
      let newChocolateBox = Math.floor(currentMax / 2);
      maxHeap.add(newChocolateBox);
      maxChocoEaten = (maxChocoEaten + (currentMax % mod)) % mod;
    }
    return maxChocoEaten;
  },
};
class MaxHeap {
  constructor(array) {
